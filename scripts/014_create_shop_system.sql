...
CREATE TABLE IF NOT EXISTS shop_items (
  ...
  preview_data JSONB, -- Stores theme colors, animation config, etc.
...
-- Points Transaction Log (for tracking spending)
CREATE TABLE IF NOT EXISTS points_transactions (
  ...
  reference_id UUID, -- References shop_item, scenario, quiz, or achievement
  description TEXT,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
